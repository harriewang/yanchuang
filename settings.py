...
DATABASE_NAME = 'yanchuang'             # Or path to database file if using sqlite3.
DATABASE_USER = 'yanchuang'             # Not used with sqlite3.
DATABASE_PASSWORD = '2010yanchuang0331'         # Not used with sqlite3.
...
MIDDLEWARE_CLASSES = (
    ...
    'django.middleware.locale.LocaleMiddleware', # Require for i18n
