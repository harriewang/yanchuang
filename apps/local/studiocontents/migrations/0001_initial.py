...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('studiocontents_news', (
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100, db_index=True)),
            ('create_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 6, 6, 22, 48, 3, 640000))),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
    ...
    models = {
        ...
        'studiocontents.news': {
            ...
            'content_en': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'content_zh_cn': ('django.db.models.fields.TextField', [], {}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 6, 22, 48, 3, 640000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
